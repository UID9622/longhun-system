...
property menuItems : {"啟動龍魂操作台（:9622）", "停止龍魂操作台", "開啟操作台網頁", "執行 CNSH 自檢", "執行每日審計", "開機自啟動 ▸ 安裝", "開機自啟動 ▸ 卸載", "查看系統狀態", "打開項目終端", "🔄 重新生成主开关菜單", "退出", "📘 查看 CNSH 說明文檔", "🔐 运行六层加密堆栈测试", "👁️ 运行 L6 灵魂层测试", "⚖️ 运行权重调谐器", "📊 查看三色审计报告", "🐉 運行底座啟動台自檢", "📋 運行腳本管理器報告", "❓ 運行 MVP 啟動器幫助", "💱 查看主權幣種", "💰 演示支付（CNY → UID1001）", "📊 XPay 交易統計", "📘 查看 XPay 設計說明"}
