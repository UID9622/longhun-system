...
def _audit(action: str, result: str, detail: str = "", color: str = "🟢") -> Dict[str, Any]:
    entry = {
...
def query_ollama(model: str, prompt: str, system: str = "", stream: bool = False) -> Dict[str, Any]:
    """查询Ollama模型"""
    if not HAS_REQUESTS:
...
def execute_cmd(cmd_name: str) -> Dict[str, Any]:
    """执行系统命令"""
