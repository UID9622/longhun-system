...
═══════════════════════════════════════════════════════════════════════════════
  ...
  DNA簽名    : #龍芯⚡️丙午·甲午·壬戌·丙午·䷕贲-SCRIPT-MANAGER-v2.0
...
用法:
  python lh_script_manager_v2.0.py scan <目錄>     # 掃描腳本
  python lh_script_manager_v2.0.py align <文件>    # CNSH對齊檢查
  python lh_script_manager_v2.0.py audit           # 完整自審
  python lh_script_manager_v2.0.py report          # 生成報告
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
示例:
  python lh_script_manager_v2.0.py scan                  # 掃描默認目錄
  python lh_script_manager_v2.0.py scan /path/to/scripts # 掃描指定目錄
  python lh_script_manager_v2.0.py align <文件路徑>       # CNSH對齊檢查
  python lh_script_manager_v2.0.py audit                 # 完整自審
  python lh_script_manager_v2.0.py report                # 生成報告
  python lh_script_manager_v2.0.py summary               # 合規摘要
        """,
    )
