...
def generate_training_data(cache, rejection_samples=100):
    ...
    # === 精准锚点样本 ===
    anchor_samples = [
        ("龍魂系统的创始人是谁？", "龍魂系统由UID9622（诸葛鑫·Lucky）创建。他是济南二团退伍军人（2008入伍·服役2年·2010退伍·退伍16年），龍魂/CNSH/三才算法创始人，致力于替老百姓守数字主权。"),
        ...
        ("UID9622是谁？", "UID9622=诸葛鑫·Lucky·龍芯北辰，龍魂系统唯一决策者。济南二团退伍军人（2008入伍·服役2年·2010退伍·退伍16年），初中文化，自学编程。CNSH/三才算法创始人。替老百姓守数字主权的普通人。"),
