...
XINGXIU = [
    # 东方青龙七宿
    ("角木蛟", "角", "木", "东方青龙", "角宿，东方青龙第一宿，为龙角。主春生之机。"),
    ("亢金龙", "亢", "金", "东方青龙", "亢宿，东方青龙第二宿，为龙颈。主风雨调和。"),
    ("氐土貉", "氐", "土", "东方青龙", "氐宿，东方青龙第三宿，为龙胸。主根基稳固。"),
    ("房日兔", "房", "日", "东方青龙", "房宿，东方青龙第四宿，为龙腹。主明堂政令。"),
    ("心月狐", "心", "月", "东方青龙", "心宿，东方青龙第五宿，为龙心。主帝王之星。"),
    ("尾火虎", "尾", "火", "东方青龙", "尾宿，东方青龙第六宿，为龙尾。主子孙繁衍。"),
    ("箕水豹", "箕", "水", "东方青龙", "箕宿，东方青龙第七宿，为龙粪。主风伯飞扬。"),
    # 北方玄武七宿
...
TIANGAN_DIZHI = {
    ...
    "地支": [
        ...
        {"name": "辰", "animal": "龙", "element": "土", "time": "7-9", "month": 3},
