...
class SolarTermWeightScheduler:
    ...
    def get_training_advice(self) -> Dict[str, Any]:
        """获取节气感知的训练建议"""
...
class WuxingLossBalancer:
    ...
    def get_wuxing_state(self) -> Dict[str, Any]:
        """将训练状态映射为五行状态"""
    ...
    def get_balance_advice(self) -> Dict[str, Any]:
        """获取五行平衡建议"""
...
class ZhongYongEarlyStopping:
    ...
    def _calc_trend(self, history: List[Dict]) -> Dict[str, Any]:
        """计算loss趋势"""
        if len(history) < 3:
...
class LHTrainingOptimizer:
    ...
    def on_training_start(self) -> Dict[str, Any]:
        """训练开始时调用"""
    ...
    def on_step_end(self, train_loss: float, val_loss: Optional[float] = None) -> Dict[str, Any]:
        """每步结束后调用"""
    ...
    def on_training_end(self) -> Dict[str, Any]:
        """训练结束报告"""
        return {
