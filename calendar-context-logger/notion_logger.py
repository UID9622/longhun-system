...
# 本地数据库路径
DEFAULT_DB_PATH = os.path.expanduser("~/.longhun/calendar-context-logger/action_log.db")
...
class ActionRecord:
    ...
    def _generate_dna(self) -> str:
        """生成DNA追溯码: #龍芯⚡️UID9622-YYYYMMDD-HHMMSS-SEQ"""
        ...
        return f"#龍芯⚡️{SYSTEM_UID}-{time_str}-{seq}"
