...
| **分类** | design |
| **类型** | HTML |
| **描述** | 品牌色彩·字体规范·设计系统·视觉一致性 |
| **标签** | design, production, verified |
| **创建日期** | 2026-06-07 |
| **最后更新** | 2026-06-08 |
| **作者** | 龍魂系统 (UID9622) |
| **质量级别** | 🟡 stable |
| **测试覆盖** | 90% |
| **可靠性评分** | 90/100 |
| **DNA签章** | `#龍芯⚡️2026-06-08-SKILL-2-BRAND-GUIDELINES-FILE1-v1.0` |
...
```json
{
  "status": "success",
  "result": {},
  "dna": "#龍芯⚡️2026-06-08-SKILL-2-BRAND-GUIDELINES-EXECUTED_F669-v1.0",
