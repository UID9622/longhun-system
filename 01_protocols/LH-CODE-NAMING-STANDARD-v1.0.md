...
def ti_jiao_suan_chou(suan_chou_shu_ju):
    min_ji = tuo_min(suan_chou_shu_ju.min_ji)
    jie_guo = ying_zhai.jia_mi(min_ji)
    return jie_guo
```
...
- 对外文档：`docs/API-REFERENCE-v1.0.md`
- 对内核心：`engines/lh_bao_gui.py`、`governance/lh_xian_fa.py`
