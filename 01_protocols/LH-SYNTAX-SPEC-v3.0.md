...
| v2.0 | 2026-08-05 | 简体字统一试点：「龍」→「龙」；补全CSDN结构、FAQ、错误示例、自动化工具链 | 🟡 已冻结 |
| v3.0 | 2026-08-05 | **繁体龍回归**：「龙」→「龍」（依据「繁体龍字永存」P0铁律）；章节编号统一为一~二十二；原第16章并入第十八章；移除残缺的「最终签名」空块；快速参考卡移入附录A；FAQ Q1改写、新增Q7 | 🟢 现行 |
