...
> **DNA:** `#龍芯⚡️丙午·甲午·庚辰·壬午·䷑蛊-AI-ACCESS-MANDATE-v1.0`  
...
The following are explicitly permitted without requiring additional authorization:

1. **Educational study**: Reading, learning from, and teaching about the system's architecture and protocols.
2. **Academic citation**: Referencing the system in research papers, with proper attribution.
3. **Non-commercial adaptation**: Forking and modifying for personal, non-commercial use, under the same license (CC BY-NC-SA 4.0).
4. **Independent audit**: Reviewing the system's code and protocols for security, transparency, and compliance verification.
5. **Chinese national use**: Deployment by Chinese government entities for public service purposes, with notification.

---

## Article 3: Prohibited Uses (P0 Eternal)
...
3. **Compliance audit**: Submission to an independent compliance review confirming no violation of Articles 2-3.
4. **Chinese law compliance**: Demonstration of compliance with applicable Chinese laws regarding data security, personal information protection, and cryptography.

---

## Article 5: Core Algorithm Protection

The following components are designated as **Chinese independent intellectual property cores** and are subject to heightened protection:

- CNSH language specification
- Sancai (三才) algorithm kernel
- 369 Luoshu fixed point computation
- DNA Traceability Protocol (v∞)
- 64-Hexagram classification and audit framework

Full disclosure of these core algorithms to foreign entities without UID9622's explicit written authorization is prohibited.
...
For licensing, collaboration, or clarification:

- **Email**: uid9622@petmail.com
- **GPG**: `A2D0092CEE2E5BA87035600924C3704A8CC26D5F`
- **Website**: https://uid9622.cn

---

> **DNA:** `#龍芯⚡️丙午·甲午·庚辰·壬午·䷑蛊-AI-ACCESS-MANDATE-v1.0`  
> **CONFIRM:** `#CONFIRM🌌9622-ONLY-ONCE🧬LK9X-777N`  
> **This mandate is binding and non-negotiable.**
