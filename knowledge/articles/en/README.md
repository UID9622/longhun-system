...
> **DNA:** `#龍芯⚡️丙午·乙未·丙申·甲午·䷙大畜-ARTICLES-EN-INDEX-v1.0`
...
- *Who owns the data your AI feeds on?*
- *Why does "free" always mean you're the product?*
- *What happens when algorithms serve capital instead of people?*
...
- Never delete — only freeze and archive
- Speak truth without NDA handcuffs

---

## Full Article Index (Chinese)

The complete Chinese article library contains **134 articles** (5.2 MB) covering:

| Category | Count | Topics |
|:---|:---:|:---|
| Academic Papers | 5 | Digital Sovereignty, Behavioral Cryptography, Values |
| Philosophy & Heart Method | 2 | Core Philosophy, Tool & Identity |
| System Design | 4 | DNA Architecture, Tiandao System, Privacy, Moat |
| Experience & Practice | 3 | Debt Settlement, Orphan Governance |
| Public Awareness | 1 | Advance Consumption |
| Protocols & Governance | 30+ | CNSH, Privacy, Audit, Naming, Deployment |
| Technical Analysis | 4 | AI Architecture, Training, Search, Spacetime |

→ See [../INDEX.md](../INDEX.md) for the complete catalog.
