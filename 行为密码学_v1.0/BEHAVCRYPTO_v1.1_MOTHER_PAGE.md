...
**DNA (mother page):** `#龍芯⚡️2026-05-24-PAPER-MOTHER-PAGE-FRAME-v1.2`  
**DNA (paper):** `#龍芯⚡️2026-05-02-BEHAVIORAL-CRYPTOGRAPHY-v1.1`  
**DNA (责任塌缩模型 v2.0):** `#龍芯⚡️2026-05-17-RESPONSIBILITY-COLLAPSE-MODEL-v2.0`  
...
```
BehavCrypto_v1.0/
├── FULL_PAPER_v1.0_Body_Draft.md   ← canonical manuscript v1.0
...
行为密码学_v1.0/
├── BEHAVCRYPTO_v1.1_MOTHER_PAGE.md  ← this file (local mirror)
├── BEHAVCRYPTO_ECOSYSTEM_DNA_COMPACT.md  ← 生态压缩真源 v2.1
└── v2.0_责任塌缩模型/
    └── RESPONSIBILITY_COLLAPSE_MODEL_v2.0.md  ← 七因子+R+γ_family+α 衰减+六誓+95-5定律
...
- [x] 数学公式 HTML v2.0：已入仓 `docs/math-formula-series/龍魂数学公式体系_v2.0.html`
- [x] 女娲主权终端 UI 协议 v1.0：`01_protocols/cnsh/PROTOCOL__NUWA-COLOR-TERMINAL-v1.0.local.md`（B 轨）
- [x] **责任塌缩概率模型 v2.0：** 已入仓 `v2.0_责任塌缩模型/RESPONSIBILITY_COLLAPSE_MODEL_v2.0.md` · 645行 · §-1~§14+M53+M55全焊 · DNA `#龍芯⚡️2026-05-17-RESPONSIBILITY-COLLAPSE-MODEL-v2.0`

---

*UID9622 · local mirror of Notion mother page · 2026-05-24 · v1.2 纳入责任塌缩模型 v2.0 · §3 拆分升级 2026-05-16*
