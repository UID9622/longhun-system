...
| **v4.1.4** | ✅ **Ollama 已注册可跑**·`longhun-v4.1.4:latest`(18GB·2026-08-28 实测回复正常)·Val⭐0.9699@200·**训练中间产物(adapter/fuse/GGUF源)已丢**(2026-08-25复核·`lora_output_v414/` 不存在)·重导出原料无·待老大决策 |
...
| **v4.1.9 run4 训练中** 🔥 | 🟡 **2026-08-31 07:40 启动**·PID 74739 存活·A-E五修复全落地(数据冻结/超长过滤4000/rollback/patience5/resume preview)·**iter1-190 nan 0次**·速度 ~1.7s/iter(0.4-0.8 it/s)·**预计今天傍晚完成(全程10-12h)**·best 1.1761@iter1(warmup期未破·正常)·数据: train 25635/valid 1312 条 |
...
| **v4.1.6** 🔥 | Yi-1.5-9B | — | 1e-7 | 已停 | 🔴 无进程(8/28复核)·log=`logs/v416_train.log` 旧日志·被v4.1.4取代 |
| v4.1.4 ✅ | Yi-1.5-9B | **0.9699@200** ⭐ | 1e-6 | 已部署 | ✅ Ollama `longhun-v4.1.4:latest`(18GB)实测可跑·训练源/GGUF源已丢(8/25复核) |
