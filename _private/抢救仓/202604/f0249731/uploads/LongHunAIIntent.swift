...
struct SanSeAuditIntent: AppIntent {
    ...
    static var description = IntentDescription("龘魂L2审计系统，返回🟢🟡🔴")
    ...
    func perform() async throws -> some IntentResult & ReturnsValue<String> {
        guard let url = URL(string: "http://192.168.100.253:8765/三色审计") else {
            return .result(value: "❌ 无法连接到龘魂本地服务")
        }
...
struct GenerateDNAIntent: AppIntent {
    ...
    static var description = IntentDescription("生成龘魂DNA追溯码")
...
struct QueryLongHunStatusIntent: AppIntent {
    static var title: LocalizedStringResource = "查询龘魂状态"
    static var description = IntentDescription("查询龘魂系统运行状态")
    ...
    func perform() async throws -> some IntentResult & ReturnsValue<String> {
        ...
        do {
            ...
            if let json = try? JSONSerialization.jsonObject(with: data) as? [String: Any] {
                let 系统 = json["系统名称"] as? String ?? "龘魂系统"
...
struct AskLongHunIntent: AppIntent {
    static var title: LocalizedStringResource = "问龘魂"
    static var description = IntentDescription("与龘魂本地AI对话，100%数据主权")
...
struct SearchMemoryIntent: AppIntent {
    static var title: LocalizedStringResource = "搜索龘魂记忆"
...
struct SaveMemoryIntent: AppIntent {
    static var title: LocalizedStringResource = "保存到龘魂"
...
struct QueryNotionIntent: AppIntent {
    static var title: LocalizedStringResource = "查询龘魂知识库"
    static var description = IntentDescription("搜索Notion知识库，龘魂大脑")
