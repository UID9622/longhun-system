...
# 🐉 龍魂系统 · 05_ENGINES/ 目录说明

> DNA: #龍芯⚡️丙午·丙申·庚戌·ENGINES-README-v1.0-UID9622
> 层编号: 05
> 规范目录: `05_ENGINES/`
> 兼容入口: `engines/` (Symlink)
...
可复用的核心引擎：审计、DNA、CNSH、数学、卦象、搜索等

## 目录结构约定

- 本目录为龍魂系统 v2.0 编号化结构的一部分。
- 旧路径 `engines/` 通过 Symlink 保留兼容，现有脚本、服务配置、文档链接无需修改。
- 新增模块应按功能子目录组织，避免顶层文件过多。

## 兼容路径查询

```bash
python3 scripts/compat-path.py resolve engines
```
