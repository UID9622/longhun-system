...
龍芯人格集群 = {
    ...
    "P72": {"名": "龍芯·龍盾",   "职能": "贴身管家·熔断决策",    "层级": "守护层", "激活": True},
    # 安全专项
...
class 人格执行器:
    ...
    def 执行(self, 人格名: str, 任务: str, 上下文: dict = None) -> str:
        ...
        引擎映射 = {
            ...
            "龍芯·龍盾":    "python3 engines/lh_persona_runner.py --persona P72",
        ...
        响应模板 = {
            ...
            "龍芯·龍盾":    f"[熔断检查] 「{任务[:50]}...」四级熔断均未触发，继续执行。",
...
def main():
    ...
    if args.status:
        ...
        演示任务 = [
            ...
            {"task": "对现有代码做安全审计", "primary": "龍芯·黑天使", "secondary": ["龍芯·上帝之眼", "龍芯·龍盾"]},
        ]
