...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
UID9622 · 诸葛鑫 · 龍芯北辰
DNA:#龍芯⚡️2026-06-07-BRAIN-NOTION-SYNC-FILE3-FILE1-FILE1-FILE1-FILE1-FILE1-v1.1-PHASE1
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def notion_create_page(memory: dict, rate_limiter: Optional[RateLimiter] = None) -> Optional[str]:
    """
...
def update_notion_id(db_path: Path, memory_id: int, notion_id: str):
...
def get_unsynced(db_path: Path) -> List[Dict]:
    """找出还没同步到 Notion 的记忆"""
    con = sqlite3.connect(str(db_path))
    con.execute("""
        CREATE TABLE IF NOT EXISTS notion_map (
...
def main():
    parser = argparse.ArgumentParser(description="🐉 龍魂脑干 Notion同步桥 v1.1 Phase 1")
