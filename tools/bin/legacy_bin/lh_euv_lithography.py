...
class CNSHMapper:
    ...
    def map_tiancai(self, P_laser: float) -> Dict[str, Any]:
        """天: P_laser映射"""
        return {
            "dimension": "天",
            "element": "能量源",
    ...
    def map_dicai(self, CE: float, tin_params: Dict[str, Any]) -> Dict[str, Any]:
        """地: CE映射 + 易经64状态机"""
    ...
    def map_rencai(self, eta_system: float, seven_factors: Dict[str, Any]) -> Dict[str, Any]:
        """人: eta_system映射 + 七因子"""
        return {
            "dimension": "人",
            "element": "收集传输",
    ...
    def _encode_tin_state(self, params: Dict[str, Any]) -> List[int]:
        """锡滴参数 → 6维二进制状态向量"""
    ...
    def verify_church_turing(self, inputs: Dict[str, Any]) -> bool:
        """Church-Turing可计算性验证"""
...
class SevenFactorSystem:
    ...
    def check_hard_failure(self, factor_values: Dict[str, Any]) -> List[str]:
    ...
    def optimize_sqp(self, bounds: Optional[Dict[str, Tuple[float, float]]] = None) -> Dict[str, Any]:
    ...
    def optimize_factors(self, method: str = "gradient") -> Dict[str, Any]:
        """七因子优化策略"""
        if method == "gradient":
    ...
    def _gradient_optimize(self) -> Dict[str, Any]:
        """梯度优化: 优先提升gap最大的因子"""
    ...
    def _greedy_optimize(self) -> Dict[str, Any]:
        """贪心优化"""
    ...
    def wuxing_diagnosis(self) -> Dict[str, Any]:
        """七因子五行分布诊断"""
...
class FixedPointSolver:
    ...
    def define_euv_coupling(self, params: Dict[str, Any]) -> callable:
    ...
    def find_steady_state(self, params: Dict[str, Any], track_trajectory: bool = False) -> Dict[str, Any]:
        """寻找稳态平衡点"""
...
class FrequencyAnalyzer:
    ...
    def analyze_window(self, freq_kHz: int) -> Dict[str, Any]:
        """分析单个频率窗口"""
    ...
    def heatmap_data(self, freq_range: List[int] = None,
                     ...
                     P_laser_range: List[float] = None) -> Dict[str, Any]:
...
class HexagramStateMachine:
    ...
    def state_to_hexagram(self, state_vector: List[int]) -> Dict[str, Any]:
        """六维状态向量 → 卦象"""
        bit_code = "".join(str(b) for b in state_vector)
        idx = int(bit_code, 2)
        return {
    ...
    def simulate_cycle(self, n_shots: int = 10000) -> Dict[str, Any]:
        """模拟锡滴射击循环"""
...
class EUVCalculator:
    ...
    def calculate(self, P_laser: float, CE: float,
                  ...
                  tin_params: Optional[Dict] = None) -> Dict[str, Any]:
        """完整EUV功率计算"""
    ...
    def _write_markdown_report(self, report: Dict[str, Any], path: str):
        """生成Markdown报告"""
        b = report["baseline"]
        c = report["comparison"]
        s = b["steady_state"]
...
"""
    ...
    def _write_html_report(self, report: Dict[str, Any], path: str):
        """生成HTML可视化报告 (v1.0新增)"""
        b = report["baseline"]
        c = report["comparison"]
        s = b["steady_state"]
...
class EUVVisualizer:
    ...
    def plot_fixed_point_trajectory(self, save_path: str | None = None):
        """不动点3D轨迹可视化"""
        try:
            import matplotlib
            matplotlib.use('Agg')
    ...
    def plot_seven_factor_radar(self, save_path: str | None = None):
        """七因子雷达图"""
        try:
            import matplotlib
            matplotlib.use('Agg')
    ...
    def plot_frequency_heatmap(self, save_path: str | None = None):
        """频率×CE热力图"""
        try:
            import matplotlib
            matplotlib.use('Agg')
...
class EUVLearningEngine:
    ...
    def record_result(self, result: Dict[str, Any], tag: str = ""):
        """记录一次计算结果"""
        record = {
            "timestamp": datetime.now().isoformat(),
            "tag": tag,
