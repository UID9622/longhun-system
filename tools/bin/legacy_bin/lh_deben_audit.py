...
class DebenAuditor:
    ...
    def check_file_for_patterns(self, filepath: Path, patterns: list[Any]) -> List[Dict]:
        """检查单个文件中是否匹配模式"""
        hits = []
    ...
    def scan_codebase(self, extensions: List[str], patterns: list[Any]) -> List[Dict]:
        """扫描代码库中匹配模式"""
        all_hits = []
        scan_dirs = [
    ...
    def run_question_1(self, quick: bool = False) -> Dict[str, Any]:
        """第一问: 帮人还是收割？"""
        if quick:
    ...
    def run_question_3(self, quick: bool = False) -> Dict[str, Any]:
        """第三问: 寒心了没？"""
        if quick:
            return {"状态": "🟢", "说明": "快速模式跳过深度扫描"}
    ...
    def run_question_4(self, quick: bool = False) -> Dict[str, Any]:
        """第四问: 主权漏了没？"""
        if quick:
            return {"状态": "🟢", "说明": "快速模式跳过深度扫描"}
    ...
    def run_question_5(self) -> Dict[str, Any]:
        """第五问: 底座动了没？"""
        # 检查关键文件是否被修改
        anchor_files = {
