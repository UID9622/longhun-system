...
def 计算BotScore(访问: dict[str, Any]) -> float:
    """BotScore = Σ wᵢ · fᵢ"""
    score = 0.0
...
def 铸入哈希链(前链: str, 日期: str, 人工账: dict[str, Any], 爬虫账: dict[str, Any], 签名: str) -> str:
...
class 龍魂礼貌爬虫:
    ...
    def 抓摘要(self, url: str, 标题: str = "", 摘要文本: str = "",
             原文: str = "", etag变了: bool = True) -> dict[str, Any]:
        """摘要抓取主入口 · 返回抓取结果"""
        域名 = self._域名(url)
