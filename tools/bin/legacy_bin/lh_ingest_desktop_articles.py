...
def chunk_text(text: str, max_chars: int = 1500, overlap: int = 200) -> list[Any]:
    """按段落分块，保持语义完整。"""
...
def make_sample(system: str, user: str, assistant: str, metadata: dict[str, Any]) -> dict[str, Any]:
    return {
        "messages": [
...
def detect_conflicts(content: str, source: str) -> list[Any]:
...
def generate_samples(path: Path, content: str) -> list[Any]:
