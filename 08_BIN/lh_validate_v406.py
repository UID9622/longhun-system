...
#!/usr/bin/env python3
#龍芯⚡️丙午·乙未·甲寅·未时·䷀乾-V406-VALIDATION-REPORT-v1.0
# CREATOR: 诸葛鑫 (UID9622)
# PROTOCOL: CC BY-NC-SA 4.0
# -*- coding: utf-8 -*-
"""
v4.0.6 部署验证脚本
DNA: #龍芯⚡️丙午·乙未·甲寅·未时·䷀乾-V406-VALIDATION-REPORT-v1.0
"""
...
DATA_DIR = PROJECT / "models" / "longhun-v1.0" / "lora_output_v406" / "data_v406"
REPORT_DIR = PROJECT / "models" / "longhun-v1.0" / "lora_output_v406" / "validation_reports"
REPORT_DIR.mkdir(parents=True, exist_ok=True)
BEST_DIR = PROJECT / "models" / "longhun-v1.0" / "lora_output_v406" / "adapter_v4.0_best"
TRAINING_LOG = PROJECT / "models" / "longhun-v1.0" / "lora_output_v406" / "training.log"

OLLAMA_GENERATE_URL = "http://localhost:11434/api/generate"
OLLAMA_CHAT_URL = "http://localhost:11434/api/chat"
MODEL = "longhun-v4.0.6"
V37_BASELINE = 0.194
V392_BEST = 0.496
V403_BEST = 0.824
V404_BEST = 0.824
...
def val_loss_audit():
    print("📊 Val Loss 对比审计")
    v406_best = load_v406_val_loss()
    delta = V37_BASELINE - v406_best
    if v406_best < V37_BASELINE * 0.9:
        color = "🟢 进步"
    elif v406_best <= V37_BASELINE:
        color = "🟡 持平"
    else:
        color = "🔴 退步"
    ...
    print(f"   差值(v3.7→v4.0.6): {delta:+.4f} → {color}")
    return {"v37": V37_BASELINE, "v392": V392_BEST, "v403": V403_BEST, "v404": V404_BEST,
            "v405": V405_BEST, "v406": v406_best, "delta": delta, "color": color}
...
| 变化(v3.7→v4.0.6) | {loss_audit['delta']:+.4f} | **{loss_audit['color']}** |
...
| 训练数据 | v3.7 + 全记忆 ingestion（技能/人格/知识/英文/日志） |
"""
