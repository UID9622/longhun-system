...
#龍芯⚡️丙午·辛未·PERSONA-START-ALL-v1.0
# CREATOR: 诸葛鑫 (UID9622)
...
# 路由表映射（从 orchestrator 同步 · 2026-08-17 Phase2 补全 P07/P08/P09/P10/P12）
ROUTE_MAP = {
    "审计": "P05", "安全": "P77", "修": "P02", "部署": "P14",
    "算": "P06", "值": "P01", "道德经": "P05", "法律": "P00",
    "创意": "P11", "代码": "P04", "文档": "P03", "部署": "P14",
    "镜": "P01", "视界": "P01", "蚁群": "P01",
    "成本": "P07", "预算": "P07", "经济": "P07",
    "命名": "P08", "术语": "P08", "通心译": "P08",
    "健康": "P09", "诊断": "P09", "自检": "P09",
    "冲突": "P10", "调解": "P10", "沟通": "P10",
    "底线": "P12", "红线": "P12", "原则": "P12",
}
