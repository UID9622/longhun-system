...
class 外脑心跳调度器:
    ...
    # 防爆炸保险
    # ═══════════════════════════════════════
    def _防爆检查(self, tier: str, 产物: str) -> dict:
    ...
    # 执行单档心跳
    # ═══════════════════════════════════════
    def 执行心跳(self, tier: str, 输入数据: str = "", 输入指纹: str = None,
                 压缩函数: Callable = None, 干运行: bool = False) -> dict:
        """执行指定档位的一次心跳"""
