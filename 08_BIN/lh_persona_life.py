...
# 人格注册表(CODE → 名/职能) 与 personas/runtime/persona_registry.json v4.0 对齐(2026-08-17修正)
PERSONAS = {
...
# 2026-08-17 修正: 剔除 P16小艺/P17宝宝入口(杂牌冻结retired) · P18凤凰·反思者→基因登记官(对齐唯一口径表20_CONFIG/persona-canonical-table.md)
...
#          基因登记官→P18 / 文心→P00 / 宝宝→P02 / 上帝之眼→P05 / 雯雯→P03
SOVEREIGN = {
    "S0": {
