...
COMMAND_ROWS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "执行命令": "curl -s http://127.0.0.1:9600/api/health && curl -s http://127.0.0.1:9600/api/event-stats && curl -s http://127.0.0.1:9600/api/skill-stats",
        "目标文件": "08_BIN/lh_dashboard_web.py",
        "验证方式": "5 个 /api/* 端点均返回 JSON",
        "状态": "已落地",
        "适用环境": ["本地"],
        "DNA": "#龍芯⚡️丙午·甲申·辛丑·坤卦-DASHBOARD-WEB-v1.0-UID9622",
        "备注": "总开关：一键体检。仪表盘数据源连通性检查。",
    },
    {
        "指令名称": "P5 · 部署仪表盘到鲲鹏",
        "阶段": "P5",
