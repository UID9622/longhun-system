...
PAGES = [
    ...
    ("大脑与智能路由", "bec1e986ff4c427999dcc9943b2b0d87.md", "龙魂自动路由系统·宝宝智能管家", "L3"),
    ("大脑与智能路由", "b53160a0479947a98c002179fc1dc298.md", "龙魂记忆中枢·DNA永生记忆", "L2"),
    ...
    # 1.4 安全与认证
    ("安全与认证", "2b525f18ec4f4e78a68edb3cac47b899.md", "龙魂数据安全架构", "L1"),
    ...
    ("审计与质量保障", "e6e50ba19da645ac9f95d83c39e8bc34.md", "龙魂系统发布验收完整方案", "L2"),
...
def check_dna_header(content: str) -> bool:
    """检查是否有DNA头"""
    return bool(re.search(r'DNA:\s*#龍芯', content)) or bool(re.search(r'DNA:\s*#龙芯', content))
