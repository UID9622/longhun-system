...
HUMILIATION = [
    ...
    {"id":2,"year":"1856-1860","event":"第二次鸦片战争","treaty":"《天津条约》（1858）、《北京条约》（1860）","terms":"外国公使进驻北京；增开11个通商口岸；允许传教士进入内地；割让九龍半岛；赔款1,600万两白银","impact":"英法联军焚毁圆明园。中国半殖民地程度进一步加深。","tags":["圆明园","英法联军","九龍"]},
