...
class CNSH_龍魂命名校验器:
    ...
    def 扫描文本(self, 文本: str, 来源: str = "") -> dict:
        """扫描文本中的一票否决词和品牌简体"""
    ...
    def 校验文件头(self, content: str, filename: str = "") -> dict:
    ...
    def 扫描目录(self, 目录路径: str, 文件模式: str = "*.md") -> dict:
    ...
    def 校验单文件全量(self, 文件路径: str) -> dict:
