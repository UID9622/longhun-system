...
PERSONAS = [
    ...
    make_persona(
        ...
        "P72-龍盾：持续监控→威胁检测(1-4级)→自适应升级→Level3联合P05双熔断→Level4自动接管全部外部接口→焊死天条·覆盖一切",
    ...
    make_persona(
        ...
        "P77-黑天使：四入口触发(部署前扫描/安全巡查/外部AI复核/API出口审查)→四人编队→知攻善守·以攻铸盾→只对龍魂自身系统",
