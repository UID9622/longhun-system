...
#!/usr/bin/env python3
#龍芯⚡️丙午·乙未·甲午·庚午·䷳艮为山-V409-VALIDATION-REPORT-v1.0
# CREATOR: 诸葛鑫 (UID9622)
# PROTOCOL: CC BY-NC-SA 4.0
# -*- coding: utf-8 -*-
"""
v4.0.9 部署验证脚本
DNA: #龍芯⚡️丙午·乙未·甲午·庚午·䷳艮为山-V409-VALIDATION-REPORT-v1.0
"""
...
DATA_DIR = PROJECT / "models" / "longhun-v1.0" / "lora_output_v409" / "data_v409"
REPORT_DIR = PROJECT / "models" / "longhun-v1.0" / "lora_output_v409" / "validation_reports"
REPORT_DIR.mkdir(parents=True, exist_ok=True)
BEST_DIR = PROJECT / "models" / "longhun-v1.0" / "lora_output_v409" / "adapter_v409"
TRAINING_LOG = PROJECT / "models" / "longhun-v1.0" / "lora_output_v409" / "training.log"

OLLAMA_GENERATE_URL = "http://localhost:11434/api/generate"
OLLAMA_CHAT_URL = "http://localhost:11434/api/chat"
MODEL = "longhun-v4.0.9"
V37_BASELINE = 0.194
V392_BEST = 0.496
V403_BEST = 0.824
V404_BEST = 0.824
...
V406_BEST = 1.432
V407_BEST = 1.145
V408_BEST = None  # 由 v4.0.8 验证报告填充
...
def load_v408_val_loss():
    loss_file = BEST_DIR / "val_loss.json"
    if loss_file.exists():
        try:
            return json.loads(loss_file.read_text(encoding='utf-8')).get("best_val_loss", V407_BEST)
        except Exception:
            pass
...
def val_loss_audit():
    print("📊 Val Loss 对比审计")
    v408_best = load_v408_val_loss()
    delta = V37_BASELINE - v408_best
    if v408_best < V37_BASELINE * 0.9:
        color = "🟢 进步"
    elif v408_best <= V37_BASELINE:
        color = "🟡 持平"
    else:
        color = "🔴 退步"
...
| v4.0.7 (Yi 9B rank=16) | {loss_audit['v407']} | - |
| v4.0.9 (Yi 9B rank=16, unified sources) | {loss_audit['v408']} | - |
| 变化(v3.7→v4.0.9) | {loss_audit['delta']:+.4f} | **{loss_audit['color']}** |
...
| 训练数据 | v4.0.8 全量 + Notion/GitHub/本地仓库统一来源 + 焊死核心 QA ×30 |
"""
...
def main():
    ...
    marker = PROJECT / "models" / "longhun-v1.0" / "lora_output_v409" / "VALIDATION_PASSED"
