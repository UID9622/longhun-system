...
DNA: #龍芯⚡️丙午·丙申·丙辰·甲午·䷑蛊-CAR-INDEX-v1.1-UID9622（生成器回填，禁止手写干支）
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == '/health':
            return self._send(200, {'status': '🟢', 'service': 'longhun-car-index', 'version': 'v1.1'})
...
def main(port: int = 8080):
    ...
    print(f'🐉 龍魂车载索引服务 v1.1 已启动 :{port}（确认码闸门: {"开" if CONFIRM_CODE else "关·调试模式"}）')
