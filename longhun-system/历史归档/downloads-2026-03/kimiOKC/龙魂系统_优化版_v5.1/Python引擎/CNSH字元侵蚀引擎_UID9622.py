...
if __name__ == "__main__":
    ...
    引擎.载入_cnsh数据_cnsh龍魂_v1("/Users/zuimeidedeyihan/Desktop/CNSH 军人的编辑器/CNSH_字元库_v0010.json")
    引擎.执行渲染_cnsh龍魂_v1("/Users/zuimeidedeyihan/Desktop/CNSH 军人的编辑器/CNSH_字元库_输出_v0010")
    print("✓ v0010 三色审计通过")
