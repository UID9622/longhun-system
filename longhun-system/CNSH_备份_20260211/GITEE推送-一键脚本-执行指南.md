...
**DNA追溯码：** #龙芯⚡️2026-01-28-GITEE-PUSH-SCRIPT-v1.0
...
cp "$SOURCE_DIR/龙魂智能终端-v3.0-漂移版.html" "02-开发工具/" 2>/dev/null || echo "    ⚠️  龙魂智能终端-v3.0-漂移版.html 未找到"
cp "$SOURCE_DIR/龙魂签名管理系统-v2.0.html" "02-开发工具/" 2>/dev/null || echo "    ⚠️  龙魂签名管理系统-v2.0.html 未找到"
cp "$SOURCE_DIR/龙魂主页-导航中心.html" "02-开发工具/" 2>/dev/null || echo "    ⚠️  龙魂主页-导航中心.html 未找到"

# 03-使用指南（5个文件）
echo "  → 03-使用指南/"
cp "$SOURCE_DIR/CNSH编辑器-使用指南.md" "03-使用指南/" 2>/dev/null || echo "    ⚠️  CNSH编辑器-使用指南.md 未找到"
cp "$SOURCE_DIR/龙魂终端v3.0-使用指南.md" "03-使用指南/" 2>/dev/null || echo "    ⚠️  龙魂终端v3.0-使用指南.md 未找到"
...
cp "$SOURCE_DIR/龙魂终端v3.0-完成报告.md" "04-完成报告/" 2>/dev/null || echo "    ⚠️  龙魂终端v3.0-完成报告.md 未找到"
...
cp "$SOURCE_DIR/龙魂多语言编译系统 - 完整交付.md" "05-春节献礼/" 2>/dev/null || echo "    ⚠️  龙魂多语言编译系统-完整交付.md 未找到"
...
cp "$SOURCE/龙魂智能终端-v3.0-漂移版.html" "02-开发工具/"
cp "$SOURCE/龙魂签名管理系统-v2.0.html" "02-开发工具/"
cp "$SOURCE/龙魂主页-导航中心.html" "02-开发工具/"

# 复制使用指南
cp "$SOURCE/CNSH编辑器-使用指南.md" "03-使用指南/"
cp "$SOURCE/龙魂终端v3.0-使用指南.md" "03-使用指南/"
