...
{''.join(路径片段)}
    ...
    def 执行渲染_cnsh龍魂_v1(self, 输出目录_cnsh9622):
        ...
        for 字元 in self.字元集_cnsh9622:
            self.输出SVG_cnsh龍魂_v1(字元, os.path.join(输出目录_cnsh9622, f"{字元}.svg"))

if __name__ == "__main__":
    引擎 = CNSH字元墨色引擎_UID9622()
    引擎.载入_cnsh数据_cnsh龍魂_v1("/Users/zuimeidedeyihan/Desktop/CNSH 军人的编辑器/CNSH_字元库_v0012.json")
    引擎.执行渲染_cnsh龍魂_v1("/Users/zuimeidedeyihan/Desktop/CNSH 军人的编辑器/CNSH_字元库_输出_v0012")
    print("✓ v0012 墨色深浅层完成")
