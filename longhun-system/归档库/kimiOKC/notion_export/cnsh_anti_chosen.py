       ...
       绑架程度 = 0.0
        ...
        if is_chosen:
            ...
            return {
                ...
                'message': f'{name}被{main_type.value}选中，绑架程度{绑架程度:.1f}%'
            }
