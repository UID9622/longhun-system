...
var computeAggregateTime = (index, nodes) => {
...
var ensureSourceLocations = (profile) => {
...
var buildModel = (profile) => {
  ...
  const locations = sourceLocations.map((l, id2) => {
  ...
  const mapId = (nodeId) => {
    let id2 = idMap.get(nodeId);
    if (id2 === void 0) {
      id2 = idMap.size;
      idMap.set(nodeId, id2);
    }
    return id2;
  };
...
// out-build/vs/platform/profiling/electron-sandbox/profileAnalysisWorker.js
...
// out-build/vs/platform/profiling/electron-sandbox/profileAnalysisWorkerMain.js
