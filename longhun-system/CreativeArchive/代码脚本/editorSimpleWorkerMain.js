...
(function(EditorOption2) {
  ...
  EditorOption2[EditorOption2["useVscodeHighlightingStyle"] = 147] = "useVscodeHighlightingStyle";
  EditorOption2[EditorOption2["effectiveCursorStyle"] = 148] = "effectiveCursorStyle";
  EditorOption2[EditorOption2["editorClassName"] = 149] = "editorClassName";
  EditorOption2[EditorOption2["pixelRatio"] = 150] = "pixelRatio";
  EditorOption2[EditorOption2["tabFocusMode"] = 151] = "tabFocusMode";
  EditorOption2[EditorOption2["layoutInfo"] = 152] = "layoutInfo";
  EditorOption2[EditorOption2["wrappingInfo"] = 153] = "wrappingInfo";
  EditorOption2[EditorOption2["defaultColorDecorators"] = 154] = "defaultColorDecorators";
  EditorOption2[EditorOption2["colorDecoratorsActivatedOn"] = 155] = "colorDecoratorsActivatedOn";
  EditorOption2[EditorOption2["inlineCompletionsAccessibilityVerbose"] = 156] = "inlineCompletionsAccessibilityVerbose";
  EditorOption2[EditorOption2["ruler"] = 157] = "ruler";
  EditorOption2[EditorOption2["ctrlClickCommand"] = 158] = "ctrlClickCommand";
  EditorOption2[EditorOption2["useCamelHumpsWords"] = 159] = "useCamelHumpsWords";
  EditorOption2[EditorOption2["honorCamelHumpsWords"] = 160] = "honorCamelHumpsWords";
...
(function(OverlayWidgetPositionPreference2) {
  ...
  OverlayWidgetPositionPreference2[OverlayWidgetPositionPreference2["BOTTOM_CENTER"] = 3] = "BOTTOM_CENTER";
...
// out-build/vs/editor/common/services/editorWorkerHost.js
...
// out-build/vs/editor/common/core/lineRange.js
...
// out-build/vs/editor/common/core/offsetEdit.js
var OffsetEdit = class _OffsetEdit {
  static {
    this.empty = new _OffsetEdit([]);
  }
  static fromJson(data) {
    return new _OffsetEdit(data.map(SingleOffsetEdit.fromJson));
  }
  static replace(range, newText) {
    return new _OffsetEdit([new SingleOffsetEdit(range, newText)]);
  }
  static insert(offset, insertText) {
    return _OffsetEdit.replace(OffsetRange.emptyAt(offset), insertText);
  }
  constructor(edits) {
    this.edits = edits;
    let lastEndEx = -1;
  ...
  tryRebase(base, noOverlap) {
    ...
    return new _OffsetEdit(newEdits);
  }
...
var SingleOffsetEdit = class _SingleOffsetEdit {
  static fromJson(data) {
    return new _SingleOffsetEdit(OffsetRange.ofStartAndLength(data.pos, data.len), data.txt);
  }
  static insert(offset, text) {
    return new _SingleOffsetEdit(OffsetRange.emptyAt(offset), text);
  }
...
// out-build/vs/editor/common/core/lineEdit.js
var LineEdit = class _LineEdit {
  static {
    this.empty = new _LineEdit([]);
  }
  static deserialize(data) {
    return new _LineEdit(data.map((e) => SingleLineEdit.deserialize(e)));
  }
  ...
  rebase(base) {
    return new _LineEdit(this.edits.map((e) => new SingleLineEdit(base.mapLineRange(e.lineRange), e.newLines)));
  }
...
var SingleLineEdit = class _SingleLineEdit {
  static deserialize(e) {
    return new _SingleLineEdit(LineRange.ofLength(e[0], e[1] - e[0]), e[2]);
  }
  static fromSingleTextEdit(edit, initialValue) {
    ...
    return new _SingleLineEdit(new LineRange(startLineNumber, endLineNumberEx), newLines);
  }
  ...
  removeCommonSuffixPrefixLines(initialValue) {
    ...
    return new _SingleLineEdit(new LineRange(startLineNumber, endLineNumberEx), this.newLines.slice(trimStartCount, this.newLines.length - trimEndCount));
  }
  toLineEdit() {
...
// out-build/vs/editor/common/core/textLength.js
...
// out-build/vs/editor/common/core/positionToOffset.js
...
// out-build/vs/editor/common/core/textEdit.js
var TextEdit = class _TextEdit {
  ...
  static single(originalRange, newText) {
    return new _TextEdit([new SingleTextEdit(originalRange, newText)]);
  }
  static insert(position, newText) {
    return new _TextEdit([new SingleTextEdit(Range.fromPositions(position, position), newText)]);
  }
  constructor(edits) {
    this.edits = edits;
  ...
  inverse(doc) {
    ...
    return new _TextEdit(this.edits.map((e, idx) => new SingleTextEdit(ranges[idx], doc.getValueOfRange(e.range))));
  }
  getNewRanges() {
    const newRanges = [];
...
var SingleTextEdit = class _SingleTextEdit {
  static joinEdits(edits, initialValue) {
    ...
    return new _SingleTextEdit(Range.fromPositions(startPos, endPos), newText);
  }
  ...
  equals(other) {
    return _SingleTextEdit.equals(this, other);
  }
  extendToCoverRange(range, initialValue) {
    ...
    return new _SingleTextEdit(newRange, newText);
  }
  ...
  removeCommonPrefix(text) {
    ...
    return new _SingleTextEdit(range, newText);
  }
...
var RangeMapping = class _RangeMapping {
  static fromEdit(edit) {
    ...
    const result = edit.edits.map((e, idx) => new _RangeMapping(e.range, newRanges[idx]));
    return result;
  }
...
// out-build/vs/editor/common/services/editorSimpleWorker.js
...
// out-build/vs/editor/common/services/editorWorkerBootstrap.js
...
// out-build/vs/editor/common/services/editorSimpleWorkerMain.js
bootstrapSimpleEditorWorker(create);

//# sourceMappingURL=editorSimpleWorkerMain.js.map
