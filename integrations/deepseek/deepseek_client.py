...
DNA: #龍芯⚡️丙午·甲午·丙子·甲午·䷙大畜-DEEPSEEK-CLIENT-v1.0
"""
import hashlib
import json
import os
...
class DeepSeekClient:
    ...
    def quick_ask(self, prompt: str, **kwargs: Any) -> DeepSeekResponse | Iterator[str]:
        """单轮问答快捷入口。非流式返回完整响应，stream=True 时返回迭代器。"""
