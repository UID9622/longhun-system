...
> AI生成代码自动审计追踪 — 记录DNA签名、三色标记、责任追溯
...
[![龍魂](https://img.shields.io/badge/龍魂-v1.0.0-D4AF37?logo=visualstudiocode&labelColor=0a0514&logoColor=D4AF37)](https://marketplace.visualstudio.com/items?itemName=uid9622.longhun-audit-tracker)
...
- **自动审计** — 粘贴/保存代码时自动记录审计日志
- **DNA签名** — 记录模型来源、提示词哈希、生成时间
- **三色标记** — AI代码标注红/黄/绿合规等级
- **责任追溯** — 完整的审计链：谁生成 → 谁审核 → 何时通过
- **报告生成** — 一键导出审计报告 JSON/CSV/Markdown
