...
> DeepSeek/Kimi/本地模型一键切换 — 根据任务类型自动选择：代码生成→DeepSeek，审查→Kimi，敏感操作→本地模型
...
[![龍魂](https://img.shields.io/badge/龍魂-v1.0.0-D4AF37?logo=visualstudiocode&labelColor=0a0514&logoColor=D4AF37)](https://marketplace.visualstudio.com/items?itemName=uid9622.model-router)
