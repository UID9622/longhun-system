<!--
  ...
  文件: CLAUDE.md | 标记时间: 2026-06-03T07:46:00+0800
-->
# 【IW-ECB v2.0】Claude Code 宪法文件
# DNA追溯码：#龍芯⚡️20260227-CLAUDE-CONSTITUTION-v1.0
...
【DNA追溯格式】
#龍芯⚡️YYYYMMDD-HHMMSS-描述-版本号-哈希

【示例】
#龍芯⚡️20260227-143025-PRIVACY-CHECK-v1.0-a3f5c9
```
...
```yaml
每个输出必须附带DNA追溯码：
格式：#龍芯⚡️YYYYMMDD-HHMMSS-描述-版本号-哈希

示例：
生成隐私检查脚本 → 
DNA: #龍芯⚡️20260227-143025-PRIVACY-CHECK-v1.0-a3f5c9
```
...
```
【操作任务】生成隐私检查脚本
【DNA追溯】#龍芯⚡️20260227-143025-PRIVACY-CHECK-v1.0-a3f5c9
【三色标注】🟢 绿色·通过
【主导熔断器】代码安全熔断器 (60%)
...
[20260227-143026] [🟢] [OP-20260227-001] DNA追溯: #龍芯⚡️...
...
**DNA追溯**: #龍芯⚡️20260227-CLAUDE-CONSTITUTION-v1.0  
**确认码**: #CONFIRM🌌9622-ONLY-ONCE🧬LK9X-772Z  
