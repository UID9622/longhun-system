<!--
  ...
  文件: LU-指令收集脚本.md | 标记时间: 2026-06-03T07:46:00+0800
-->
# LU指令收集脚本
...
graph TD
    ...
    B --> D["记忆管理指令"]
    B --> E["系统部署指令"]
    C --> F["/LU-PERSONA-ID-MAP"]
    C --> G["/LU-PERSONA-RECALL-ALL"]
    C --> H["/LU-PERSONA-MEMORY-MAP"]
    D --> I["/LU-MEMORY-VIEW"]
    D --> J["/LU-MEMORY-SYNC"]
    D --> K["/LU-MEMORY-MERGE-ALL"]
    D --> L["/LU-ORIGIN-FULLSYNC"]
    E --> M["/LU-DO-DEPLOY"]
```
