...
def make_entry(system: str, user: str, assistant: str, domain: str, meta: dict) -> dict:
    """构建一条标准训练数据"""
...
def generate_qa(chapters: dict) -> list:
    """从81章生成所有QA对"""
    entries = []
...
def split_and_save(entries: list, out_dir: str):
    """分割训练/验证集并保存"""
