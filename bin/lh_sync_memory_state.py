...
def build_live_section(live: Dict, state: Dict) -> str:
    """构建实时状态快照区块"""
    lines = []
    lines.append(f"\n---\n\n## §LIVE. 实时状态快照")
...
def update_memory_md(live: Dict, state: Dict, dry_run: bool = False) -> Dict:
    """更新MEMORY.md的实时状态区块"""
...
def diff_model_tables(state: Dict) -> List[str]:
