...
PRINCIPLES_DATA = [
    {
        ...
        "pillars": [
            ...
            {"name": "修正原则", "desc": "龙魂禁止两种极端：犯错后隐藏，或犯错后自毁。正确道路：犯错→记录→分析→修正→保留痕迹。错误不是污点，是成长数据。"},
    ...
    },
    {
        ...
        "origin": "记忆是存在的证据。如果记忆可以被随意覆盖，那么存在就是可以被随意否定的。龙魂认为：覆盖是最隐蔽的暴力——它不删除你，它让你从未存在过。",
        "pillars": [
    ...
    },
    {
        ...
        "pillars": [
            ...
            {"name": "授权不等于委托", "desc": "授权是给予权限，委托是授予代表权。龙魂禁止最终责任的委托。"},
    ...
    },
    {
        ...
        "origin": "语言是存在的载体。当语言失真时，思想失真，判断失真，行动失真。失真是一切误解、错误和冲突的根源。龙魂认为：保持信息的完整性，是保持认知完整性的前提。",
        "pillars": [
    ...
    },
    {
        ...
        "origin": "文明不是权力游戏，而是责任游戏。当权力被滥用时，文明就开始腐烂。龙魂认为：权力的合法性来源只有一个——它服务于谁，就对谁负责。",
        "pillars": [
