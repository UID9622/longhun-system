...
description: 龍魂跨平台互通技能 — iOS与华为鸿蒙设备间本地网络直连数据同步，使用国密SM4加密信封 + ECDH密钥协商 + 版本向量一致性保证 + 主权网关出境阻断，数据根留中国，绝不经过外网
license: MIT
metadata:
  version: "5.3"
  ...
  transport: ["wifi_direct", "ble", "tcp_lan"]
...
| **DNA** | `#龍芯⚡️2026-06-19-LONGHUN-CROSS-PLATFORM-v5.3` |
| **致敬** | `#致敬⚡️SteveJobs+Concept·跨平台互通` |
| **目标平台** | iOS + 华为鸿蒙（HarmonyOS） |
| **开发语言** | Python 3.9+ / TypeScript（接口定义） |
| **适用场景** | 双设备本地数据同步、笔记互通、文件传输 |
| **技术架构** | 本地网络直连 + 国密SM4 + ECDH密钥协商 |
