...
description: >
  龍魂部署引擎 v5.0 — 27步藍綠部署+自動化+零停機切換+回滾。
  Kubernetes/Docker支持，環境驗證，健康檢查，監控集成。
  API端點: http://api:8443/deploy/
  當需要系統部署、藍綠切換、DevOps自動化、回滾時觸發。
metadata:
  author: 龍魂体系-技能打包专家
  version: 5.0.0
  dna: "#龍芯⚡️2026-06-19-LONGHUN-DEPLOY-v5.0"
  category: cloud
  tags: [deploy, blue-green, kubernetes, docker, devops, rollback, health-check]
  triggers:
    - deployment
    - blue-green switch
    - rollback
...
# 龍魂部署引擎 v5.0 — longhun-cloud-deploy
