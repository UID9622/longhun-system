...
**DNA 追溯码**：`#龍芯⚡️丙午·甲午·己卯·庚午·䷚颐-ENSPI-INSTALL-GUIDE-v3.0`
...
| macOS（苹果电脑） | 任何版本 | ⚠️ 能装，但麻烦 | 必须装虚拟机，在虚拟机里装Windows | 详见第五章 |
| Linux 电脑 | 任何发行版 | ⚠️ 能装，但麻烦 | 必须装虚拟机，在虚拟机里装Windows | 详见第五章 |
| iOS / iPadOS（iPhone/iPad） | — | ❌ 不能装 | 无方案 | 已知不兼容 |
...
| **SHA-256 校验值** | 需从官方下载后自行计算，或使用龍魂校验工具比对（详见3.3节） |
| **龍魂辅助** | 龍魂安装脚本可自动校验 |
...
| **备用下载链接（SHA256SUMS）** | [VirtualBox 5.2.44 校验文件](https://download.virtualbox.org/virtualbox/5.2.44/SHA256SUMS) |
| **MD5 校验值** | `d0ed2c2b2f1bb3c2ff4f261f40617c55`（请优先以 SHA-256 为准） |
| **SHA-256 校验值** | `2335e98f1c41f3aad5e16d2d5d18298e19d1cb04021fd752e3e2cd952996c7cd` |
...
| **MD5 校验值** | `a11a2f0cfe6d0b4c50945989db6360cd` |
| **SHA-256 校验值** | `fc4623b113a1f603c0d9ad5f83130bd6de1c62b973be9892305132389c8588de` |
...
| **直接下载链接（x64）** | [Wireshark-4.4.5-x64.exe](https://www.wireshark.org/download/win64/Wireshark-4.4.5-x64.exe) |
| **SHA-256 校验值** | `2dfdd1116d1f2c5a916a223b3e421f43fd15a6d2fdb7e2be23ce280d2062e19f` |
...
|---------|------|---------|------|----------|
| **龍魂 eNSP 安装辅助脚本** | 自动校验 + 顺序安装 + 环境检测 | `~/longhun-system/scripts/ensp_setup_helper.py` | ✅ 可用 | `#龍芯⚡️2026-TOOL-ENSPI-SCRIPT` |
| **龍魂 eNSP 哈希校验工具** | 文件哈希批量校验 | `~/longhun-system/tools/ensp_hash_checker.py` | ✅ 可用 | `#龍芯⚡️2026-TOOL-ENSPI-HASH` |
| **龍魂 eNSP 下载助手** | 自动下载官方依赖并校验 | `~/longhun-system/tools/ensp_downloader.py` | ✅ 可用 | `#龍芯⚡️2026-TOOL-ENSPI-DOWNLOADER` |
| **龍魂字体（CNSH）** | 解决界面显示乱码 | `~/longhun-system/longhun-font/assets/LonghunFont-Regular-v0004.otf` | ✅ 可用 | `#龍芯⚡️2026-TOOL-ENSPI-FONT` |
| **龍魂字体安装脚本（macOS）** | 一键安装龍魂字体 | `~/longhun-system/longhun-font/install_macos.sh` | ✅ 可用 | `#龍芯⚡️2026-TOOL-ENSPI-FONT-MAC` |
| **龍魂字体安装脚本（Windows）** | 一键安装龍魂字体 | `~/longhun-system/longhun-font/install_windows.bat` | ✅ 可用 | `#龍芯⚡️2026-TOOL-ENSPI-FONT-WIN` |
| **CNSH 运行时** | 龍魂生态命令行环境 | `~/longhun-system/cnsh-core` 或 `~/longhun-system/cnsh_terminal_v5.0` | ✅ 可用 | `#龍芯⚡️2026-TOOL-ENSPI-RUNTIME` |
...
python3 ~/longhun-system/tools/ensp_hash_checker.py --file "C:\Users\你的用户名\Downloads\VirtualBox-5.2.44-139111-Win.exe"

# 批量校验整个下载文件夹
python3 ~/longhun-system/tools/ensp_hash_checker.py --dir "C:\Users\你的用户名\Downloads\龍魂_eNSP_套件"
```

**步骤3**：比对工具显示的哈希值与上表中的官方哈希值是否一致

**步骤4**：如果一致 → ✅ 文件安全，可以安装

**步骤5**：如果不一致 → ❌ 文件可能被篡改，删除重下，换官方链接
...
flowchart TD
    ...
    CHECK_OS -->|macOS 苹果电脑| MAC_PATH[⚠️ 走虚拟机方案<br/>DNA: #龍芯⚡️2026-ENSPI-NODE-02]
    CHECK_OS -->|Linux 电脑| LINUX_PATH[⚠️ 走虚拟机方案<br/>DNA: #龍芯⚡️2026-ENSPI-NODE-03]
    CHECK_OS -->|iOS / iPadOS| NO_GO_IOS[❌ 不能装<br/>DNA: #龍芯⚡️2026-ENSPI-NODE-04-IOS]
    ...
    NO_GO_IOS --> END_FAIL_IOS([结束：iOS/iPadOS 不支持<br/>DNA: #龍芯⚡️2026-ENSPI-NODE-29-IOS])
...
| 6 | 界面中文乱码 | 菜单显示方块或问号 | 系统缺少中文字体 | ① 安装龍魂字体 `LonghunFont-Regular-v0004.otf`<br>② 或安装微软雅黑字体 | 字体自动安装脚本 | `#龍芯⚡️2026-ENSPI-FAQ-06` |
...
```bash
# 龍魂 eNSP 环境检查脚本
python3 ~/longhun-system/scripts/ensp_setup_helper.py

# 龍魂依赖自动下载（VirtualBox / Wireshark / WinPcap）
python3 ~/longhun-system/tools/ensp_downloader.py --output "~/Downloads/龍魂_eNSP_套件"

# 龍魂哈希校验
python3 ~/longhun-system/tools/ensp_hash_checker.py --dir "~/Downloads/龍魂_eNSP_套件"
```
...
```bash
# macOS 一键安装
bash ~/longhun-system/longhun-font/install_macos.sh

# Windows 一键安装（以管理员身份运行 CMD）
~/longhun-system/longhun-font/install_windows.bat
```

字体文件本地路径：
- `~/longhun-system/longhun-font/assets/LonghunFont-Regular-v0004.otf`
...
```json
{
  "dna": "#龍芯⚡️丙午·甲午·己卯·庚午·䷚颐-ENSPI-INSTALL-GUIDE-v3.0",
