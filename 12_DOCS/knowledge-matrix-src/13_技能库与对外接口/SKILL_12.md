...
metadata:
  version: '1.0'
  dna:
  - '#龍芯⚡️丙午·癸巳·戊申·戊午·䷙大畜-MATH-FORMULA-CORE-DUAL-TRACK-v1.0'
  - '#龍芯⚡️丙午·甲午·戊辰·戊午·䷑蛊-LONGHUN-MATH-FORMULA-CORE-SKILL-v1.0'
  author: UID9622 · 龍芯北辰
...
**原始 DNA：** `#龍芯⚡️丙午·癸巳·戊申·戊午·䷙大畜-MATH-FORMULA-CORE-DUAL-TRACK-v1.0`  
**技能转换 DNA：** `#龍芯⚡️丙午·甲午·戊辰·戊午·䷑蛊-LONGHUN-MATH-FORMULA-CORE-SKILL-v1.0`
