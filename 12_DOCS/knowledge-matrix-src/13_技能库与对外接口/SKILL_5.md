...
description: '龍魂MCP服務 v5.0 — FastMCP集成+工具定義+Dockerfile自動生成+配置管理。 支持龍魂體系14個技能的MCP協議暴露，統一工具註冊中心。
  API端點: http://api:8443/mcp/ 當需要MCP服務、工具定義、AI協議集成、Docker構建時觸發。
...
metadata:
  ...
  - scripts/MCP服務器.py
  protocol: 君子協議
  id: longhun-cloud-mcp
  trigger:
    keywords:
    - cloudmcp
    - 龍魂MCP服務
    - v5.0
    - FastMCP集成+工具定義+Dockerfile自動生成+配置管理。
    - 支持龍魂體系14個技能的MCP協議暴露
    - 統一工具註冊中心。
    context: longhun-cloud-mcp 相关操作
---
...
```
#龍芯⚡️丙午·甲午·甲子·庚午·䷙大畜-LONGHUN-MCP-v5.0
