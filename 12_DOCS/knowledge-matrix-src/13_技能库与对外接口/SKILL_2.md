...
metadata:
  ...
  version: v5.3
  category: local
  dna: '#龍芯⚡️丙午·甲午·甲子·庚午·䷙大畜-LONGHUN-HARMONYOS-v5.3'
...
```
#龍芯⚡️丙午·甲午·甲子·庚午·䷙大畜-LONGHUN-HARMONYOS-v5.3-{timestamp}-{random}
```
...
const 协议记录 = {
  dna_tag: '#龍芯⚡️丙午·甲午·甲子·庚午·䷙大畜-LONGHUN-HARMONYOS-v5.3',
  timestamp: Date.now(),
