...
description: '龍魂操作台 v5.0 — FastAPI统一API+Web UI，10项Skill+底座能力联动。 本地技能与云端技能的统一入口，请求路由分发，health
  check监控。 API端点: http://api:8443/panel/ 当需要统一操作台、API网关、Skill联动调度、Web UI时触发。

  '
metadata:
  id: longhun-cloud-panel
  version: '5.1'
  dna: '#龍芯⚡️丙午·甲午·甲子·庚午·䷙大畜-LONGHUN-PANEL-v5.1'
  trigger:
    keywords:
    - cloudpanel
    - 龍魂操作台
    ...
    - UI
    - 10项Skill+底座能力联动。
    context: longhun-cloud-panel 相关操作
  category: general
---
...
龍魂操作台是龍魂體系 v5.1 的統一 API 網關與 Web 管理界面。它集成了十項 Skill 的聯動調度、三大底座能力（龍盾安全、CNSH 中文編程、融合審計）以及完整的 DNA 追溯與三色審計系統。
...
DNA 標記: `#龍芯⚡️丙午·甲午·甲子·庚午·䷙大畜-LONGHUN-PANEL-v5.0`
...
```
#龍芯⚡️丙午·甲午·甲子·庚午·䷙大畜-LONGHUN-PANEL-v5.0
├── 面板名稱: 龍魂操作台
