...
metadata:
  id: longhun-backup
  version: '5.1'
  dna: '#龍芯⚡️丙午·甲午·戊寅·戊午·䷕贲-LONGHUN-BACKUP-v5.1'
  trigger:
    keywords:
    - backup
    - 龍魂备份恢复系统
    ...
    - Recovery
    - v5.1)。
    context: longhun-backup 相关操作
  category: general
---
# 龍魂备份恢复系统 (L12)

**DNA**: `#龍芯⚡️丙午·甲午·甲子·庚午·䷙大畜-LONGHUN-BACKUP-v5.1`
...
**龍魂备份恢复系统 v5.1** | DNA: `#龍芯⚡️丙午·甲午·甲子·庚午·䷙大畜-LONGHUN-BACKUP-v5.1`
