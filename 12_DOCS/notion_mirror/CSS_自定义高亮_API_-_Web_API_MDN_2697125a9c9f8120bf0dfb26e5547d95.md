# CSS 自定义高亮 API - Web API | MDN

> Notion URL: https://app.notion.com/p/CSS-API-Web-API-MDN-2697125a9c9f8120bf0dfb26e5547d95
> Created: 2025-09-09T14:18:00.000Z
> Last edited: 2025-09-18T19:18:00.000Z
...
1. 为这些范围创建 Highlight 对象。
1. 使用 HighlightRegistry 进行注册。
1. 使用 ::highlight() 伪元素定义高亮样式。
...
```
最后一步是为已注册高亮显示设置样式。可以使用 ::highlight() 伪元素来完成。例如，为上一步注册的 user-1-highlight 设置高亮样式：
 此接口用于表示要在文档上设置样式的范围集合。    可以通过 CSS.highlights 访问，类 Map 对象用于使用自定义标识符注册高亮显示。 
