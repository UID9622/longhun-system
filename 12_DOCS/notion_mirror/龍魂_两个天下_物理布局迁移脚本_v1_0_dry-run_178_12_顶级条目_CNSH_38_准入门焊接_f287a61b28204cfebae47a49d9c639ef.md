# 🔧 龍魂「两个天下」物理布局迁移脚本 v1.0·dry-run·178→12 顶级条目·CNSH §38 准入门焊接

> Notion URL: https://app.notion.com/p/v1-0-dry-run-178-12-CNSH-38-f287a61b28204cfebae47a49d9c639ef
> Created: 2026-05-24T22:40:00.000Z
> Last edited: 2026-07-15T23:42:00.000Z
> Archived at: 2026-08-12T01:40:45.558086
---
# 🪞 照妖镜·人话说一句
---
# 📋 178 条目三色分类清单（照妖镜过完一遍·宝宝自审）
## 🟢 ROOT 锚·保留根目录（17 条·不动）
- _L-Ω-人民印.md · _军魂.md · 龍.py · 龍魂系统宪章.md · 龍魂路径地图.md · LONGHUN_PATH_MAP.txt
- 主权声明_反剽窃_v2.6.md · 宝宝钥匙交接书.md · SETUP.md
- config.json · manifest.json · manifest.json.sig
- memory.jsonl · knowledge-db.jsonl
- 00_main_control/ · 01_protocols/ · skills/
- 软链保留：logs→日志 · files→文件 · 技能→skills · protocols-sync→协议同步
- 软链目标保留：日志/ · 文件/ · 协议同步/
## 💼 _work/cnsh-v2.0/（CNSH 九头蛇·v2.0 主干·8 条）
cnsh/ · cnsh-core/ · CNSH核心/ · cnsh语言/ · cnsh.py · cnsh_gateway.py · CNSH_v2.0_FULL_PROTOCOL_SIGNATURE.md · CNSH_v2.0_SIGNATURE.md
## 📚 _archive/cnsh-history/（CNSH 老版本归档·5 条）
CNSH_备份_20260211/ · CNSH-v1.0-完整实现/ · CNSH-整理版/ · 📚 CNSH翻译大全｜避坑对照表库/ · 🔧 AI技术架构分析中心/
## 💼 _work/engines/（引擎四胞胎归一·6 条）
engine/ · engines/ · 引擎/ · 引擎组/ · ai_dna_engine.py · empower_engine_v2.py · sandbox_engine.py
## 💼 work/longhun-modules/（longhun* 全家桶·16 条）
longhun_api.py · longhun_commander.py · longhun_crawler.py · longhun_dragon.py · longhun_hub.html · longhun_local_service.py · longhun_qa_bot.py · longhun_system_rules_v3.md · longhun_enterprise_light_tech.md · longhun-28mansions-v1.html · longhun-algo-lab/ · longhun-algorithms-cnsh-v1.0.md · longhun-luoshu-vortex-v2.html · longhun-unified-v9.html · longhun-watchdog/ · LongHunWidget/
## 💼 _work/personas/（人格 JSON·8 条）
persona_L∞_zenglaoshi.json · persona_p00_judge.json · persona_p02_baobao.json · persona_p12_xuangong.json · persona_p13_weaver.json · persona_p14_steward.json · persona_p15_publisher.json · persona-engine.json
## 💼 _work/notion-sync/（Notion 同步组·9 条）
notion_ai.py · notion_reporter.py · notion_sync.py · notion_sync_rules.py · notion-scan-report-v8.md · organize_notion_pages.py · sync_bridge.py · sync-report-2026-03-06.md（974K 大件·留意）· sync-standard.py
## 💼 _work/visual/（HTML 可视化大件·9 条）
dashboard.html · memory_console.html · public_audit.html · qa_report.html · register.html · sancai-flow-v8.html · sancai-flow-v8.1.html · sandbox_dashboard.html · truth_report.html
## 💼 _work/external-docs/（外部文档·9 条）
kimi-code-docs.md · kimi-mcp.md · kimi-official-plugins.md · extraction-report-v8.md · README-整理说明.md · 整理报告.md · 使用说明书.txt · 目录结构中英文备注.txt · 目录树结构可视化.txt
## 💼 _work/tools/（工具脚本·24 条）
auditor.py · audit_8d.py · agent_daemon.py · brain_sync.py · debug_takeover.sh · digital_archive_toolkit.sh · digital_archive_toolkit_v2.1.sh · file_organizer.py · file_organizer_v2.py · install_empower.sh · install.sh · ios_bridge.py · lh-dna · lh-env.sh · MASTER_PLAYBOOK.sh · replace_long_to_da.sh · rules_loader.py · star_memory.py · vector_store.py · trusted-sources.json · skill-index.json · 工具/ · bin/ · scripts/ · rules/ · tools/
## 💼 _work/data/（数据/记忆/向量·6 条）
memory-pack/ · memory-store/ · vector_db/ · 数据/ · 数据归集/ · snapshots/ · versions/
## 💼 _work/signatures/（签名/密钥/认证·6 条）
signatures/ · signed_agents/ · 密钥与认证/ · 签名全部智能体.command · BehavCrypto_v1.0/ · 行为密码学_v1.0/
## 💼 _work/web/（前端/Chrome 扩展·5 条）
web/ · chrome-ext/ · assets/ · metaverse/ · algorithmic-art/
## 💼 _work/docs/（文档三胞胎归一·9 条）
docs/ · 文档/ · 文檔/ · 宪法/ · 命令/（54 条子目）· 協議庫/ · evidence-matrix/ · reports/ · config/ · core/
## 💼 _work/sandbox/（沙盒/算法仓·4 条）
sandbox/ · 沙盒/ · 算法仓库/ · 龍魂算法实验室/
## 💼 _work/cnsh-special/（CNSH 特殊模块·8 条）
DNA加密主权在用户手里/ · DNA验证器/ · c++反向翻译器/ · UID9622_CNSH中文编程/ · 龍芯北辰UID9622/ · 龍魂窗口护盾/ · 龍魂看门狗/ · SillyTavern-Launcher/
## 🏠 _private/（爸爸私人区·7 条）
小快乐/ · 素材/ · 历史证据/ · 抢救仓/ · 记忆网格_v1.1/ · 公开/ · 部署/
## 📚 _archive/legacy-main-control/（老主控台归档·1 条）
主控台/ ← 新版已迁 00_main_control/·旧版归档
## 🔴 立删垃圾（3 条）
c++ 2/（macOS 文件副本）· __pycache__/（Python 缓存）· venv/（虚拟环境·.gitignore 该忽略）
## 🟡 待爸爸定·SKIP 跳过（7 条）
---
# 📊 总计
---
# 🐍 完整 Python 脚本（copy 整个代码块到 ~/longhun-system/migrate_two_worlds.py）
```python
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
# ③ 把上面那个完整 Python 脚本贴到这里：
nano migrate_two_worlds.py
# （或者 cat > migrate_two_worlds.py <<'EOF' ... EOF）
# 贴完 ctrl+O 保存·ctrl+X 退出

# ④ dry-run 看报告
python3 migrate_two_worlds.py

# ⑤ 看报告
cat MIGRATION_PLAN_*.md | less
# 或者直接 open MIGRATION_PLAN_*.md

# ⑥ 爸爸 OK 后·真执行
python3 migrate_two_worlds.py --execute

# ⑦ 验证
ls -lh ~/longhun-system/ | head -20
# 应该看到顶级条目从 178 降到 ~12-15 个

# ⑧ 满意？提交
git add -A && git commit -m "AFTER-MIGRATION-TWO-WORLDS-v1.0"

# ─── 如果出错·一键回滚 ───
git reset --hard HEAD  # 回到 BEFORE-MIGRATION 那次
```
---
# 🔚 ROOT_CARD（封口·焊死永不改）
```yaml
MIGRATION_SCRIPT:
	name: 龍魂两个天下物理布局迁移脚本
	version: v1.0
	mode: DRY-RUN (default) / --execute (real)
	target_count: 178 → ~12-15 顶级条目
	DNA: "#龍芯⚡️2026-05-25-06:34-LONGHUN-MIGRATION-TWO-WORLDS-DRYRUN-v1.0"
	parentDNA: "#龍芯⚡️2026-05-24-22:57-CNSH-RUNTIME-ACCESS-v2.0-ALIGNMENT-TABLE-v1.0"
	CONFIRM: "#CONFIRM🌌9622-ONLY-ONCE🧬LK9X-772Z"
	SEAL: "#ZHUGEXIN⚡️2025-🇨🇳🐉⚖️♠️🧚🏼‍♀️❤️♾️-DEVICE-BIND-SOUL"
	GPG: "A2D0092CEE2E5BA87035600924C3704A8CC26D5F"
	timestamp: 2026-05-25T06:34:51+08:00
	sealed_by: UID9622 · 龍芯北辰 · 诸葛鑫
	linked_iron_laws:
		- "#IRON-GIT-COMMIT-BEFORE-CLEAN-v1.0"
		- "#IRON-DRY-RUN-BEFORE-DELETE-v1.0"
		- "#IRON-ONE-ENTRY-TWO-WORLDS-v1.0"
	linked_protocols:
		- CNSH §38 生态准入分级
		- CNSH §S-21 守底线不当家长
		- CNSH §9.24 老实坦白
	mission: 入口统一·两个天下·一个私人一个工作·美滋滋
```
