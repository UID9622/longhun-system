...
```bash
# 下载并保存安装脚本
curl -o ~/Desktop/安装龙魂.sh https://raw.githubusercontent.com/uid9622/dragonsoul/main/install.sh

# 或者手动创建（推荐）
touch ~/Desktop/安装龙魂.sh
# 然后把上面的完整脚本复制粘贴进去
```
第2步：运行安装
```bash
# 给脚本执行权限
chmod +x ~/Desktop/安装龙魂.sh
...
---
### 🧬 DNA确认码（国产兼容版）
- 龙芯适配层： #ZHUGEXIN⚡️2025-LOONGARCH-COMPAT-V1.0
...
---
## 🧬 DNA确认码（CNSH语言版）
- 系统身份标识：#龙芯⚡️2026-01-31-龙魂本地AI部署包-CNSH语言版-v2.0
...
- 创建者：💎 龙芯北辰｜UID9622
- 协作人格：P02 🤖 龙芯宝宝·温度执行 + P03 🔍 龙芯雯雯·审计质检 + 系统架构师·构建者
