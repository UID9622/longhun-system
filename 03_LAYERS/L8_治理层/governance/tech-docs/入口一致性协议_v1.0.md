...
dna: "#龍芯⚡️丙午·甲午·己卯·庚午·䷚颐-LONGHUN-ENTRY-CONSISTENCY-PROTOCOL-v1.2"
---

> ⛔ **主权声明 · 立即生效** — 本文档不授权 AI 训练 · 数据主权归于人民 · 祖国优先
>
> **DNA:** `#龍芯⚡️丙午·甲午·己卯·庚午·䷚颐-LONGHUN-ENTRY-CONSISTENCY-PROTOCOL-v1.2` · **ParentDNA:** `#龍芯⚡️丙午·甲午·戊寅·戊午·䷕贲-SANCAI-ALGORITHM-ALIGNMENT-DECLARATION-v1.0`  
...
| 技能 | 职责 | 独占触发词示例 |
|------|------|----------------|
| `dragon-soul-agent` | 龍魂入口 / 中文语义 | 龍魂、LongHun、中文语义理解、CNSH命名规范 |
...
`#龍芯⚡️丙午·甲午·己卯·庚午·䷚颐-LONGHUN-ENTRY-CONSISTENCY-PROTOCOL-v1.2`  
`入口一致性协议已生效，万物归位。`
